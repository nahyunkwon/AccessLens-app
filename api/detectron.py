...
import sys
# sys.path.append('/home/nahyun/Projects/detectron2')
...
def set_cfg():
    cfg = get_cfg()
    print()
    cfg.merge_from_file(model_zoo.get_config_file("faster_rcnn_R_50_FPN_1x.yaml"))
    ...
    cfg.MODEL.WEIGHTS = "../detectron2/model_final_b275ba.pkl"  # Let training initialize from model zoo
...
def test_image(image_dir):
    ...
    cfg.MODEL.WEIGHTS = os.path.join("output", "../detectron2/model_0002799.pth")
