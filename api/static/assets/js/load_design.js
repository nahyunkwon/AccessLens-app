...
function load_object(object_name){
    ...
    img.src = 'static/assets/images/object_icons/' + object_name + '.png';
...
var object_icons = document.getElementById("object-icons");

for(var i=0;i<objects.length;i++){
    object_icons.appendChild(load_object(objects[i]));
}
